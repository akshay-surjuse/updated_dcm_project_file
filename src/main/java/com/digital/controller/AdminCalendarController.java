...
public class AdminCalendarController {
    ...
    @PutMapping(path = "/calendar/holidays/{holidayId}")
    ...
    public ResponseEntity<String> removeHoliday(@PathVariable Long holidayId){
        ...
        return new ResponseEntity<String>(calendarService.removeHoliday(holidayId), HttpStatus.NO_CONTENT);
    }
    ...
    public ResponseEntity<String> removeEvent(@PathVariable Long eventId){
        ...
        return new ResponseEntity<String>(calendarService.removeEvent(eventId), HttpStatus.NO_CONTENT);
    }
}
